...
export const SOURCES = [
  // ────────────────────────────── Россия ──────────────────────────────
  {
    ...
    status: 'ПРОВЕРЕНО 06.09.2026: машинного доступа нет (RSS 404/403, sitemap без lastmod), поэтому разбираем HTML списка. В категории 376 тендеров, бюджеты 100 000 – 1 200 000 ₽, поток ~1–2 в неделю. Адаптер проверен на реальной сохранённой странице: 10 карточек из 10, бюджеты и даты верные. НЕ ПРОВЕРЕНО: пользовательское соглашение площадки насчёт автоматического сбора.',
  },
  {
    id: 'infostart',
    kind: 'infostart',
