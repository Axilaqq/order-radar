...
// Поэтому разбираем HTML страницы списка https://workspace.ru/tenders/.
//
// robots.txt запрещает /tenders/? и /tenders/*/? — любые параметры запроса,
// то есть фильтры и пагинацию. Сама /tenders/ не запрещена: ходим только
// туда и никогда не подставляем query-строку.
//
